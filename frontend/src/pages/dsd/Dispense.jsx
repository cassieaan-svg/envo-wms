...
export function Dispense() {
  ...
  const stockRow     = dsdStockRow

  // Current stock-on-hand for a commodity at this DSD site. Null when no record.
  ...
  async function handleSubmit(e) {
    ...
    // the DSD site stock (server-side).
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">Record stock consumed at {dsdSiteName}</p>
      </div>
