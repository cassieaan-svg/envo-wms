...
const RULES = {
  ...
  // Retired from the picker (RETIRED_REASONS) — it was a catch-all that made
  // adjustments unclassifiable. Kept in RULES so historical 'Other' records still
  // resolve (display, edit); it just can't be chosen for a new adjustment.
